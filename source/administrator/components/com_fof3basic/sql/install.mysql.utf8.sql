CREATE TABLE IF NOT EXISTS `#__fof3basic_examples` (
	`fof3basic_example_id`         INT(11) UNSIGNED NOT NULL AUTO_INCREMENT,
	`fof3basic_category_id`        INT(11) UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS `#__fof3basic_categories` (
	`fof3basic_category_id`   INT(11) UNSIGNED NOT NULL AUTO_INCREMENT,
	`title`                        VARCHAR(255)     NOT NULL,
	`slug`                         VARCHAR(255) NOT NULL DEFAULT '',
